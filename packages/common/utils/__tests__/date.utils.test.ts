...
describe('getRoundedDate', () => {
  ...
  it('should round the date to the nearest 5 min', () => {
    const date = new Date(2018, 0, 1, 1, 1, 1, 1)
    expect(getRoundedDate(5, date).valueOf()).toEqual(1514764800000)
  })

  it('should round the date to the nearest 5 min current date', () => {
    jest.useFakeTimers('modern')
    jest.setSystemTime(new Date(2018, 0, 1, 1, 1, 1, 1))

    expect(getRoundedDate(5).valueOf()).toEqual(1514764800000)
  })
})
